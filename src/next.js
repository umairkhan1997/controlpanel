        ...
        <div className={classes.appFrame}>
          ...
          >
            <Toolbar disableGutters={!open}>
              ...
              <RaisedButton  className={classes.h1} onClick={this.SignOut.bind(this)}>log out</RaisedButton>
            </Toolbar>
          </AppBar>
          {before}
          <main
...
export default connect(mapStateToProp, mapDispatchToProp)(withStyles(styles,{ withTheme: true })(PersistentDrawer));
